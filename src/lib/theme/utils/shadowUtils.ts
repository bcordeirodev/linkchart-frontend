 ...
 */
export const getShadowByIntensity = (
  theme: Theme,
...
export const createColoredShadow = (
  ...
  const shadowColor = alpha(
    color,
    isDark ? config.opacity * 1.5 : config.opacity,
  );
 ...
 */
export const createNeumorphismShadow = (
  theme: Theme,
  intensity: ShadowIntensity = "medium",
): string => {
  const isDark = theme.palette.mode === "dark";
 ...
 */
export const createStateShadows = (
  theme: Theme,
...
export const createResponsiveShadow = (
  ...
  const tabletShadow = tablet
    ? getShadowByIntensity(theme, tablet)
    : mobileShadow;
  const desktopShadow = desktop
    ? getShadowByIntensity(theme, desktop)
    : tabletShadow;
