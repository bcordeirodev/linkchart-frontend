 ...
 */
export const createResponsiveValue = <T>(theme: Theme, property: string, values: ResponsiveValue<T>): SxProps => {
	const result: any = {};
 ...
 */
export const createResponsiveTypography = (theme: Theme, sizes: ResponsiveValue<string | number>): SxProps => {
 ...
 */
export const createResponsivePadding = (theme: Theme, values: ResponsiveValue<number | string>): SxProps => {
 ...
 */
export const createResponsiveMargin = (theme: Theme, values: ResponsiveValue<number | string>): SxProps => {
 ...
 */
export const createResponsiveGrid = (theme: Theme, columns: ResponsiveValue<number>): SxProps => {
...
export const createResponsiveLayouts = (theme: Theme) => {
	return {
		...
		responsiveStack: createResponsiveFlex(
			theme,
			{
				xs: 'column',
				md: 'row'
