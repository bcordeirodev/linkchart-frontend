 ...
 */
export const createTransition = (theme: Theme, properties: string | string[], config: AnimationConfig = {}): string => {
	const { duration = 'standard', delay = 0, easing } = config;
 ...
 */
export const createFadeAnimation = (theme: Theme, config: AnimationConfig = {}): SxProps => {
	return {
