...
export const API_CONFIG = {
	BASE_URL: import.meta.env.DEV ? '' : import.meta.env.VITE_API_URL || 'http://localhost:8000', // Use proxy em dev, API direta em prod
...
export const API_ENDPOINTS = {
	AUTH: {
		...
		EMAIL_VERIFICATION_STATUS: API_CONFIG.ENDPOINTS.AUTH.EMAIL_VERIFICATION_STATUS,
		RESEND_VERIFICATION_EMAIL: API_CONFIG.ENDPOINTS.AUTH.RESEND_VERIFICATION_EMAIL
	}
};
