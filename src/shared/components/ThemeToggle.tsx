 ...
 */
export function ThemeToggle({ size = 'medium', color = 'inherit', className, onThemeChange }: ThemeToggleProps) {
	 ...
	 */
	const tooltipText = isDarkMode ? 'Alternar para tema claro' : 'Alternar para tema escuro';
