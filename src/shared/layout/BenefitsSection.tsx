...
const defaultBenefits: Benefit[] = [
  {
    ...
    description:
      "Veja de onde vêm seus cliques, dispositivos, países e muito mais",
  },
  {
    title: "🎨 Links Personalizados",
    description:
      "Crie slugs personalizados para sua marca (ex: linkcht.com/minha-empresa)",
  },
  {
    title: "📱 QR Codes Automáticos",
    description:
      "Gere QR codes personalizáveis para seus links automaticamente",
  },
  {
...
export function BenefitsSection({
  ...
  return (
    ...
    >
      {/* Header */}
      <Box>
        <Fade in={headerMounted} timeout={800} mountOnEnter unmountOnExit>
          <Box>
