...
import { Box, useTheme, Typography, alpha, Paper } from '@mui/material';
...
function AuthLayout({
    ...
    const authLayouts = useMemo(
        ...
        [className, variantConfig, showSideSection, isMobile, title, subtitle, footerLinks]
    );
