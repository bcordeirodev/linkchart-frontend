...
- `base/` — primitivas estendendo MUI (`EnhancedPaper`, `EmptyState`, `AnalyticsEmptyState`, `ResponsiveContainer`, `AppLogo`, `AnalyticsStateManager`, `PageSectionHeading`, `SectionLabel`, `OverviewMetricRow`, `cardSurface.ts`/`getCardSurfaceSx`).
