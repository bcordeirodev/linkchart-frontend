            ...
            {onAnalytics && (
                <Tooltip title="Ver Analytics">
                    <IconButton
                        ...
                        size={mapSize(size)}
                    >
                        <AppIcon intent="analytics" size={20} />
                    </IconButton>
                </Tooltip>
            )}
            ...
            {onDownload && (
                <Tooltip title="Download">
                    <IconButton
                        ...
                        size={mapSize(size)}
                    >
                        <AppIcon intent="download" size={20} />
                    </IconButton>
                </Tooltip>
            )}
