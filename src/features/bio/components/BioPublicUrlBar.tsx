 ...
 *
 * No card shell of its own: the only call site (`BioEditor`) renders this
 * directly below `BioPublishingFields`, already inside that section's own
 * hairline card — wrapping it in a second `EnhancedPaper` would nest a card
 * inside a card. A hairline top border stands in for the missing card edge,
 * marking this off as the section's read-only sub-block.
 */
