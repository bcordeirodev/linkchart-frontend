...
export const ProfileBadge = styled(Box, {
	shouldForwardProp: (prop) => prop !== 'isVerified'
})<ProfileBadgeProps>(({ theme, isVerified = true }) => ({
	position: 'absolute',
	top: theme.spacing(2),
	...
	color: isVerified ? theme.palette.success.contrastText : theme.palette.warning.contrastText,
