...
export function RetentionAnalysisChart({
    ...
    const benchmarkBarOptions = {
        ...
        colors: [
            data.benchmark_comparison === 'excellent' ? theme.palette.success.main :
                data.benchmark_comparison === 'good' ? theme.palette.info.main :
                    data.benchmark_comparison === 'average' ? theme.palette.warning.main :
    ...
    const getBenchmarkColor = (comparison: string) => {
        switch (comparison) {
            ...
            case 'average': return theme.palette.warning.main;
                        ...
                        <CardContent>
                            <Stack spacing={2}>
                                ...
                                <Typography variant="body1">
                                    ...
                                    {data.benchmark_comparison === 'excellent' && 'muito acima da média da indústria. Excelente trabalho!'}
                                    {data.benchmark_comparison === 'good' && 'acima da média da indústria. Bom desempenho!'}
                                    {data.benchmark_comparison === 'average' && 'na média da indústria.'}
                                    {data.benchmark_comparison === 'needs_improvement' && 'abaixo da média da indústria.'}
                                </Typography>
