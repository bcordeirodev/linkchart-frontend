import { Grid, Box, Typography, Alert, CircularProgress, Card, CardContent } from '@mui/material';
...
import { Speed, CheckCircle, Schedule, TrendingUp, Public, Assessment } from '@mui/icons-material';
		...
		<Box sx={{ p: 3 }}>
			...
			<Box sx={{ mt: 4 }}>
				...
				>
					...
					<Typography variant="body2">
						• Seus links estão respondendo{' '}
						{performanceMetrics.avgResponseTime < 500 ? 'rapidamente' : 'adequadamente'}(
						{performanceMetrics.avgResponseTime}ms é{' '}
						...
						<br />• Taxa de sucesso de {performanceMetrics.successRate}% indica{' '}
						...
						confiabilidade
						<br />•{' '}
						{performanceMetrics.uniqueVisitors > 0
							? `Engajamento positivo com ${performanceMetrics.uniqueVisitors} visitantes únicos`
							: 'Aguardando primeiros visitantes'}
					</Typography>
				</Alert>
			</Box>
		</Box>
