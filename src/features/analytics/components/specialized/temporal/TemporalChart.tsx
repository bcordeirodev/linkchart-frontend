...
import { HourlyData, DayOfWeekData } from '@/features/analytics/hooks/useEnhancedAnalytics';
							...
							<>
								<ApexChartWrapper
									...
									options={{
										...
										xaxis: {
											...(formatAreaChart(hourlyData, 'label', 'clicks', '#ff9800', isDark)
												.options?.xaxis || {}),
											title: {
												text: 'Hora do Dia'
											}
						...
						{weeklyTotal > 0 ? (
							<>
								<ApexChartWrapper
									type="bar"
									height={300}
									{...formatBarChart(weeklyData, 'day_name', 'clicks', '#9c27b0', false, isDark)}
									options={{
										...formatBarChart(weeklyData, 'day_name', 'clicks', '#9c27b0', false, isDark)
											.options,
										xaxis: {
