...
import { ArrowBack, Analytics, TrendingUp, Public, Devices, Schedule, Lightbulb, Map } from '@mui/icons-material';
...
export function EnhancedAnalytics({ linkId }: EnhancedAnalyticsProps) {
				...
				<Card>
					<CardContent sx={{ textAlign: 'center', py: 6 }}>
						...
						<Typography
							...
							color="text.secondary"
						>
							Em breve você terá acesso a mapas de calor, análise por países, horários de pico e muito
							mais.
						</Typography>
					</CardContent>
				</Card>
	...
	return (
		<Box sx={{ p: 3 }}>
			...
			{tabValue === 4 && <BusinessInsights insights={data?.insights || []} />}
		</Box>
	);
}
