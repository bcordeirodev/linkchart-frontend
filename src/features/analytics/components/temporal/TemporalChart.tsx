							...
							<Typography variant='body2'>
								...
								{hourlyTotal > 0 ? (
									<>
										...
										{peakHour.clicks} clicks). Dia com mais engajamento:{' '}
										<strong>{peakDay.day_name}</strong> ({peakDay.clicks} clicks).
									</>
								) : (
										...
										<Stack spacing={1}>
											{peakHour && peakHour.clicks > 0 ? (
												...
												>
													...
													{t('temporal.chart.peakHourLabel')} com {peakHour.clicks} cliques.
