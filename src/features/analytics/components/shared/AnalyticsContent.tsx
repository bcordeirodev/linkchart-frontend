...
import { TemporalAnalysisEnhanced } from '../temporal/TemporalAnalysis';
    ...
    return (
        <Box>
            ...
            <Box sx={{ ...animations.fadeIn }}>
                ...
                {/* Audiência Tab */}
                <TabPanel value={tabValue} index={getTabIndex(4)}>
                    <Box sx={{ mb: 2 }}>
                        <TabDescription
                            icon="👥"
                ...
                {/* Heatmap Tab */}
                <TabPanel value={tabValue} index={getTabIndex(5)}>
                    <HeatmapAnalysis
                        data={data}
                        linkId={linkId}
                    />
                ...
                {/* Insights Tab */}
                <TabPanel value={tabValue} index={getTabIndex(6)}>
                    <InsightsAnalysis
                        linkId={linkId}
                        globalMode={globalMode}
                        showTitle={false}
