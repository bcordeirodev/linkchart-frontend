...
import { Box, Card, CardContent, Typography, Paper, alpha } from "@mui/material";
...
const ISO2_TO_NUMERIC: Record<string, string> = {
  AF: "004", AL: "008", DZ: "012", AO: "024", AR: "032", AU: "036", AT: "040",
  AZ: "031", AM: "051", BD: "050", BE: "056", BA: "070", BY: "112", BO: "068",
  BR: "076", BG: "100", CA: "124", CI: "384", CL: "152", CM: "120", CN: "156",
  CO: "170", CR: "188", CU: "192", CZ: "203", DE: "276", DK: "208", DO: "214",
  EC: "218", EE: "233", EG: "818", ES: "724", ET: "231", FI: "246", FR: "250",
  GE: "268", GH: "288", GT: "320", HN: "340", HR: "191", HU: "348", ID: "360",
  IE: "372", IL: "376", IN: "356", IQ: "368", IR: "364", IT: "380", JO: "400",
  JP: "392", KE: "404", KR: "410", KW: "414", KZ: "398", LB: "422", LK: "144",
  LT: "440", LU: "442", LV: "428", LY: "434", MA: "504", MD: "498", ME: "499",
  MG: "450", MK: "807", MX: "484", MY: "458", MZ: "508", NG: "566", NI: "558",
  NL: "528", NO: "578", NZ: "554", PA: "591", PE: "604", PH: "608", PK: "586",
  PL: "616", PT: "620", PY: "600", QA: "634", RO: "642", RS: "688", RU: "643",
  SA: "682", SE: "752", SI: "705", SK: "703", SN: "686", SV: "222", SY: "760",
  TH: "764", TN: "788", TR: "792", TW: "158", TZ: "834", UA: "804", UG: "800",
  US: "840", UY: "858", UZ: "860", VE: "862", VN: "704", YE: "887", ZA: "710",
  ZM: "894", ZW: "716", AE: "784", GB: "826", CH: "756",
};
...
export function GeographicChoropleth({
  ...
  const [tooltip, setTooltip] = useState<TooltipState>({
    x: 0, y: 0, country: "", clicks: 0, percentage: "0", visible: false,
  });
          ...
          {tooltip.visible && (
            ...
            >
              ...
              <Typography variant="caption" color="text.secondary">
                {tooltip.clicks.toLocaleString()} {t("geographic.choropleth.clicks")} · {tooltip.percentage}%
              </Typography>
            </Paper>
          )}
        </Box>
