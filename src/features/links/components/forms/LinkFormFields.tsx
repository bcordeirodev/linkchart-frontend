		...
		<Stack spacing={2.5}>
			...
			<Box sx={{ mt: 1 }}>
				<Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1.5 }}>
					<Typography variant='subtitle1'>{t('form.advancedSettings')}</Typography>
					<Chip
								...
								<Controller
									...
									render={({ field }) => (
										<TextField
											...
											helperText={errors.custom_slug?.message || t('form.customSlugHelper')}
										/>
									)}
								/>
							</Grid>
								...
								<Controller
									...
									render={({ field: { onChange, value, ...field } }) => (
										<TextField
											...
											helperText={errors.click_limit?.message || t('form.clickLimitHelper')}
											InputProps={{
											...
											<DateTimePicker
												...
												slotProps={{
													textField: {
														...
														helperText:
															errors.starts_in?.message || t('form.startDateHelper'),
														sx: {
											...
											<DateTimePicker
												...
												slotProps={{
													textField: {
														...
														helperText:
															errors.expires_at?.message || t('form.expiresAtHelper'),
														sx: {
															'& .MuiOutlinedInput-root': {
																borderRadius: 1.5
															}
								...
								<Controller
									...
									render={({ field }) => (
										<TextField
											...
											helperText={errors.utm_source?.message || t('form.utmSourceHelper')}
										/>
									)}
								/>
							</Grid>
								...
								<Controller
									...
									render={({ field }) => (
										<TextField
											...
											helperText={errors.utm_medium?.message || t('form.utmMediumHelper')}
										/>
									)}
								/>
							</Grid>
								...
								<Controller
									...
									render={({ field }) => (
										<TextField
											...
											helperText={errors.utm_campaign?.message || t('form.utmCampaignHelper')}
										/>
									)}
								/>
							</Grid>
								...
								<Controller
									...
									render={({ field }) => (
										<TextField
											...
											helperText={errors.utm_term?.message || t('form.utmTermHelper')}
										/>
									)}
								/>
							</Grid>
								...
								<Controller
									...
									render={({ field }) => (
										<TextField
											...
											helperText={errors.utm_content?.message || t('form.utmContentHelper')}
										/>
									)}
								/>
							</Grid>
