...
export function ClicksTable({ linkId }: ClicksTableProps) {
	...
	const COLUMNS: MRT_ColumnDef<LinkClickItem>[] = [
		{ accessorKey: 'created_at', header: t('analytics.clicksTable.date'), minSize: 160, size: 200, Cell: WhenCell },
		{
			id: 'location',
		...
		{ accessorKey: 'device', header: t('analytics.clicksTable.device'), minSize: 110, size: 140, Cell: DeviceCell },
		{
			accessorKey: 'browser',
		...
		{ accessorKey: 'os', header: t('analytics.clicksTable.os'), minSize: 110, size: 140, Cell: OsCell },
		{
			id: 'referer',
		...
		{ accessorKey: 'ip', header: t('analytics.clicksTable.ip'), minSize: 100, size: 140, Cell: IpCell }
	];
