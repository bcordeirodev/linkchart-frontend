	...
	return (
		...
		>
			<Box sx={{ flex: 1, minWidth: 0 }}>
				<Typography sx={{ fontSize: '0.8125rem', fontWeight: 600, color: 'rgba(255,255,255,0.6)', mb: 0.5 }}>
					{t('publicAnalytics.saveUrlBanner.title')}
				</Typography>
				<Typography sx={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.28)', lineHeight: 1.55, mb: 2 }}>
				...
				>
					...
					<Box
						...
						sx={{
							...
							'&:hover': { color: copied ? '#34d399' : 'rgba(255,255,255,0.55)' }
						}}
					>
						{copied ? <Check {...ICON_SM} /> : <Copy {...ICON_SM} />}
						{copied ? t('publicAnalytics.saveUrlBanner.copied') : t('publicAnalytics.saveUrlBanner.copy')}
					</Box>
				</Box>

				<Typography sx={{ fontSize: '0.6875rem', color: 'rgba(255,255,255,0.16)', mt: 1.25, lineHeight: 1.5 }}>
