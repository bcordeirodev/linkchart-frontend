...
export default function RedirectPage() {
    ...
    const handleRedirect = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/r/${shortCode}`, {
                method: 'GET',
                headers: {
    ...
    const handleCreateLink = () => {
        window.open(`${import.meta.env.VITE_FRONTEND_URL || window.location.origin}/shorter`, '_blank');
    };
    ...
    useEffect(() => {
        ...
        fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/r/${shortCode}?preview=true`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    }, [shortCode, link]); // Adicionado link como dependência para evitar loops
