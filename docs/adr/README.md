...
- [0003 — Redux para UI / TanStack Query para servidor](0003-redux-para-ui-tanstack-query-para-estado-de-servidor.md) — _superseded pela 0008_
...
- [0008 — Remoção do Redux: contexts React para estado de UI](0008-remocao-do-redux-contexts-para-estado-de-ui.md)
